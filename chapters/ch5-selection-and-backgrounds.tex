...
\begin{figure}[tp]
    ...
    \caption{Dalitz distribution for $\D\to\KS\pi\mu\nu_\mu$ decays in RapidSim, where the $\KS\pim$ originate in the resonances $\Kstarm(892)$, $\Kstarm_0(1430)$, $\Kstarm_2(1430)$, and $\Kstarm(1680)$, as well as for a uniform distribution over phase space.}
