...
\begin{figure}[tbp]
    \centering
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/m2_chi2_PiPi_LL.png}
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/m2_chi2_PiPi_DD.png}
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/m2_chi2_KK_LL.png}
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/m2_chi2_KK_DD.png}
...
\begin{figure}[tbp]
    \centering
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/s_KolSmi_PiPi_LL.png}
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/s_KolSmi_PiPi_DD.png}
...
\begin{figure}[tbp]
    \centering
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/s_KolSmi_KK_LL.png}
    % \includegraphics[width=\columnwidth]{figs/theory/feasibility/s_KolSmi_KK_DD.png}
