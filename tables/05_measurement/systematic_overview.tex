\begin{table}
\centering
\caption{Overview of all sources of uncertainty on the measurement. \mccorrect{Due the number of pseudo experiments used to determine the systematic uncertainties, the \emph{uncertainty on the quoted systematic uncertainties} is approximately $0.05\times10^{-2}$. In many cases that is of approximately the same size as the uncertainties themselves, but much smaller than the dominating, statistical uncertainty.}
