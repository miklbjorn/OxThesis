...
$\texttt{log(Bach\_PT)}                                 $ & 5.2 \% / 6.9 \% \phantom{1}(1)  & $p_T$ of the companion particle  \\
...
$\texttt{log(Bach\_IPCHI2\_OWNPV)}                      $ & 3.3 \% / 4.3 \% (10)  & $\chi^2_{\text{IP}}$ of the companion particle  \\
...
$\texttt{log(Bach\_P)}                                  $ & 2.2 \% / 3.6 \% (15) & $p$ of the companion particle   \\
